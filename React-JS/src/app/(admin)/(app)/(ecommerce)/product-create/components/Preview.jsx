      ...
      <div className="sticky top-20">
        <div className="card">
          <div className="card-body">
            <h6 className="mb-4 card-title">Aperçu de la Fiche Produit</h6>
            ...
            <div className="mt-3">
              ...
              <h6 className="mb-1 text-[15px] font-semibold text-default-800">
                Fastcolors Typography Homme
              </h6>
              <p className="text-default-600">Mode Homme</p>
            </div>

            <h6 className="mt-3 mb-2 card-title">Couleurs</h6>
            ...
            <h6 className="mt-3 mb-2 card-title">Tailles</h6>
            <div className="flex gap-2 flex-wrap items-center">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-2 mt-4">
              ...
              <button className="bg-purple-500 text-white btn hover:bg-purple-600">Brouillon</button>
            </div>
          </div>
        </div>
      </div>
