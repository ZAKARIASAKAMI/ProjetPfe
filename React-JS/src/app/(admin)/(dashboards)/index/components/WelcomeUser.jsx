  ...
  return <div className="card-body relative overflow-hidden bg-zinc-900 rounded-md mb-5">
    <div className="relative z-10 grid grid-cols-12 items-center">
      <div className="lg:col-span-8 col-span-12">
        <h5 className="mb-3 text-lg text-white">Welcome Paula Keenan (Stock Manager) 🎉</h5>
        <p className="mb-5 text-white/70 text-sm">
          A stock management dashboard provides your team with a
          clear overview of inventory levels, recent movements, and warehouse capacity at any time.
        </p>
