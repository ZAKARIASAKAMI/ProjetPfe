...
const ProductEdit = lazy(() => import('@/app/(admin)/(app)/(ecommerce)/product-edit'));
...
// admin Stock (New)
const AvailableStock = lazy(() => import('@/app/(admin)/(app)/(stock)/available'));
const RecordEntry = lazy(() => import('@/app/(admin)/(app)/(stock)/entry'));
const RecordExit = lazy(() => import('@/app/(admin)/(app)/(stock)/exit'));
const WarehouseList = lazy(() => import('@/app/(admin)/(app)/(warehouse)/list'));
const AddWarehouse = lazy(() => import('@/app/(admin)/(app)/(warehouse)/add'));
const TransferProducts = lazy(() => import('@/app/(admin)/(app)/(warehouse)/transfer'));
const Movements = lazy(() => import('@/app/(admin)/(app)/(stock)/movements'));
...
const UserOverview = lazy(() => import('@/app/(admin)/(app)/(users)/user-overview'));
const UserEdit = lazy(() => import('@/app/(admin)/(app)/(users)/user-edit'));
